...
export default {
  ...
  methods: {
    ...
    goToLastPage() {
      const pageCount = this.$refs['myDataGrid2'].instance.pageCount();
      console.log('page count: ', pageCount)
      this.pageIndex = pageCount - 1;
    },
    getTotalPageCount() {
      return this.$refs['myDataGrid2'].instance.pageCount();
    }
  },
  created() {
    setTimeout(()=>{
      console.log('get total page count: ', this.getTotalPageCount())
    }, 2500)
